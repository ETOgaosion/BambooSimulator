...
class OobSimulatorBase(ABC):
    ...
    def __init__(self,
        ...
        self.start_nodes_num = start_nodes_num
        self.last_active_instances = self.start_nodes_num
    ...
    def simulate_should_reconfigure(self) -> bool:
        curr_active_instances = self.get_curr_active_instances()
        if curr_active_instances == self.last_active_instances:
            return False
        else:
            return True
    ...
    def get_curr_active_instances(self)->int:
