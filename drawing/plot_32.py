...
dirs = {'bamboo': 'bamboo',  'varu': 'varu', 'oobleck': 'oobleck', 'oobleck_opt': 'oobleck-opt', 'livepipe-red1': 'livepipe-red1', 'livepipe-red2': 'livepipe-red2', 'livepipe': 'livepipe-red1'}
traces = ['g4dn', 'p3']
probabilities = [0.2]
frequencies = ['1h', '2m']
            ...
            for system_i, system in enumerate(systems):
                ...
                for breakdown_name in list(reversed(breakdown_names)):
                    ...
                    if breakdown_name == 'delta_effective_time':
                        # axs.bar_label(p, label_type='edge', fmt='%.2f', fontsize=14, padding=)
