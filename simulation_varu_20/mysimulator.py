...
class MySimulator(Simulator):
    def __init__(self, seed=None, start_hour=None,
                 model='GPT-3', model_size='gpt3_1_3B', spot_instance_desired_capacity=24, pipeline_parallel_size=2, ckpt_steps=100, spot_instance_trace='traces/p3-trace-16.csv', performance_log_interval=1, runnable_instances=None, generate_addition_probabilities=False, removal_probability=None, generate_graphs=False):
