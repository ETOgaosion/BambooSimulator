...
# reconfigure_case('traces/g4dn-trace-16.csv')
# reconfigure_case('traces/g4dn-trace.csv')
# reconfigure_case('traces/p3-trace-16.csv')
# reconfigure_case('traces/p3-trace.csv')
...
generate_trace_8_24('traces/g4dn-trace.csv', 'traces/g4dn-trace-16.csv')
generate_trace_8_24('traces/p3-trace.csv', 'traces/p3-trace-8-24.csv')
...
def plot_nodes_samples(seconds, nodes_samples, prefix):
    ...
    fig.tight_layout()
    fig.savefig(f'traces/{prefix}_nodes_samples.png')
